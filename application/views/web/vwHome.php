...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <div class="headMenu2">
            <div class="row">
                ...
                <div class="medium-4 columns">
                    <div id="menuAppH1">DESCARGALA AHORA</div>
                    <div id="menuAppH2">TODAS LAS PROMOCIONES EN LA PALMA DE TU MANO</div>
                    <a href="<?php echo base_url(); ?>apps"><img id="btnMoreInfo" src="<?php echo base_url().IMG; ?>web/btnMoreInfo.png" /></a>
                </div>
                <div class="medium-3 columns">
                    <a class="btnAppStore" href="#"><img src="<?php echo base_url().IMG; ?>web/btnApp2.png" /></a>
                </div>
                <div class="medium-3 columns">
                    <a class="btnAppStore" href="#"><img src="<?php echo base_url().IMG; ?>web/btnApp1.png" /></a>
                </div>
                <div class="medium-1 columns">&nbsp;</div>
            </div>
        </div>
        ...
        <div class="mainMenu">
            <div class="row">
                <div class="medium-2 columns homeMenu optMenu">
                    ...
                    <?php foreach ($cupones as $item):?>
                        <li>
                            <figure class="couponObj">
                                <img  class="openModal" attr-id="<?php echo $item->id;?>" attr-description="<?php echo $item->description;?>" src="<?php echo base_url().IMG; ?>app/coupon/min/<?php echo $item->image;?>">
                                <figcaption>
                                    <h3><?php echo $item->description;?></h3>
                                    <span>
                                        <u class="linkPartner" attr-id="<?php echo $item->partnerId;?>"><?php echo $item->partnerName;?></u>
                                    <a class="openModal" attr-description="<?php echo $item->description;?>" attr-id="<?php echo $item->id;?>"></a>
                                </figcaption>
                            </figure>
                        </li>
                    <?php endforeach;?>
                        ...
                        <li>
                            <figure class="couponObj">
                                ...
                                <figcaption>
                                    ...
                                    <span>
                                        <u class="linkPartner" attr-id="<?php echo $item->partnerId;?>"><?php echo $item->partnerName;?></u>
                                    <a class="openModal" attr-id="<?php echo $item->id;?>" attr-description="<?php echo $item->description;?>"></a>
                                </figcaption>
                            </figure>
                        </li>
                    <?php endforeach;?>
                    ...
                    <section id="grid" class="grid clearfix">
                        <?php foreach ($events as $item):?>
                            <a data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z">
                                <figure>
                                    <img src="<?php echo base_url().IMG; ?>app/event/max/<?php echo $item->image;?>" />
